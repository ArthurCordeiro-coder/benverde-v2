                  ...
                  <ReactMarkdown
                    components={{
                      ...
                      code: ({ children, className }) => {
                        ...
                        return isBlock ? (
                          <code className="block overflow-x-auto rounded-xl bg-black/40 px-4 py-3 font-mono text-xs text-emerald-200">
                            {children}
                          </code>
                        ) : (
                          <code className="rounded bg-black/30 px-1 py-0.5 font-mono text-xs text-emerald-300">
                            {children}
                          </code>
                        );
                      },
                      ...
                      h3: ({ children }) => <h3 className="mb-1 text-sm font-semibold text-slate-200">{children}</h3>,
                      blockquote: ({ children }) => (
                        <blockquote className="mb-2 border-l-2 border-emerald-400/40 pl-3 text-slate-400 italic">
                          {children}
                        </blockquote>
                      ),
