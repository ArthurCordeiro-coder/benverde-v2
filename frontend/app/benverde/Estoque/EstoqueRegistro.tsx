...
export default function EstoqueRegistro() {
  ...
  return (
    <div className="min-h-full bg-[radial-gradient(circle_at_top,_rgba(234,179,8,0.18),_transparent_35%),_#07130d] px-4 py-8 text-gray-100">
                  ...
                  {registrosHoje.map(r => (
                    <tr key={r.id} className="hover:bg-white/5 transition-colors">
                      ...
                      <td className="py-3 text-right flex items-center justify-end gap-1">
                        <button
                          onClick={() => router.push(`/benverde/Estoque/correcao?id=${r.id}`)}
