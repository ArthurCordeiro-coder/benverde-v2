  ...
  return (
    <section className="mx-auto max-w-7xl space-y-8 pb-20 text-gray-100">
      ...
      <button
        ...
        className="fixed bottom-6 right-4 z-[110] flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-green-400 to-emerald-600 text-white shadow-[0_8px_32px_rgba(16,185,129,0.4)] transition-all hover:scale-110 active:scale-95 lg:bottom-8 lg:right-8 lg:h-16 lg:w-16"
      >
          ...
          <div className="custom-scrollbar flex-1 space-y-4 overflow-y-auto p-6 text-sm font-medium">
            {chatMessages.length === 0 ? (
              ...
              chatMessages.map((message, index) => (
                ...
                >
                  <div className={`max-w-[85%] rounded-[20px] px-4 py-2 text-sm leading-relaxed ${bubbleClass(message.role)}`}>
