...
function Nav() {
  ...
  const navLinks = ["Soluções", "Lumii-IA", "Recursos", "Roadmap", "Preço", "Contato"];
  const linkHref = (item: string) =>
  ...
  return (
    <>
      <nav
        ...
        style={{
          background: scrolled ? "rgba(8,3,26,0.85)" : "rgba(8,3,26,0.60)",
      ...
      >
        ...
        {/* Desktop links */}
        <div className="lumii-nav-links hidden items-center gap-1 md:flex">
          {navLinks.map((item) => (
            <a
              key={item}
              href={linkHref(item)}
        ...
        {/* Desktop CTAs */}
        <div className="lumii-nav-ctas flex items-center gap-2.5">
          <Link
            href="/login"
          ...
          <Link
            ...
            className="flex items-center gap-1.5 rounded-xl border-none px-4 py-2 text-sm font-semibold text-[#0c0525] transition-all hover:-translate-y-px"
            style={{ background: "linear-gradient(135deg, #ffe566, #f5d030)", boxShadow: "0 8px 24px rgba(32,10,94,0.30), inset 0 1px 0 rgba(255,255,255,0.30)", pointerEvents: "none", opacity: 0.5, cursor: "not-allowed" }}
          >
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <button
          className="lumii-hamburger"
          onClick={() => setMenuOpen((v) => !v)}
          aria-label={menuOpen ? "Fechar menu" : "Abrir menu"}
          aria-expanded={menuOpen}
          style={{ background: "transparent", border: "1px solid rgba(255,255,255,0.15)", borderRadius: 12, padding: "8px 10px", color: "#e2e8f0", cursor: "pointer" }}
        >
          {menuOpen ? (
      ...
      <div className="lumii-mobile-menu" data-open={menuOpen ? "true" : "false"}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "20px 24px 18px", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
          <a href="#top" onClick={close} className="flex items-center gap-2.5 no-underline">
            <BrandMark size={26} />
            <span style={{ fontSize: 16, fontWeight: 700, letterSpacing: "-0.01em", color: "#f1f5f9" }}>lumii</span>
          </a>
          <button
            onClick={close}
            style={{ background: "transparent", border: "1px solid rgba(255,255,255,0.12)", borderRadius: 10, padding: "6px 8px", color: "#94a3b8", cursor: "pointer" }}
          >
        ...
        <div style={{ flex: 1, padding: "8px 16px" }}>
          {navLinks.map((item) => (
            <a
              ...
              href={linkHref(item)}
              onClick={close}
              style={{ display: "block", padding: "15px 12px", color: "#e2e8f0", textDecoration: "none", fontSize: 17, fontWeight: 500, borderBottom: "1px solid rgba(255,255,255,0.05)", fontFamily: "var(--lumii-font-sans)" }}
            >
              {item}
            </a>
          ))}
        ...
        <div style={{ padding: "20px 16px 48px", display: "flex", flexDirection: "column", gap: 12 }}>
          <Link
            href="/login"
            onClick={close}
            style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8, padding: "15px", borderRadius: 14, border: "1px solid rgba(255,255,255,0.18)", color: "#f1f5f9", textDecoration: "none", fontWeight: 600, fontSize: 15, fontFamily: "var(--lumii-font-sans)" }}
          >
            Entrar
          </Link>
          <span
            title="Cadastros temporariamente pausados"
            style={{ display: "flex", alignItems: "center", justifyContent: "center", padding: "15px", borderRadius: 14, background: "linear-gradient(135deg, #ffe566, #f5d030)", color: "#0c0525", fontWeight: 700, fontSize: 15, opacity: 0.45, cursor: "not-allowed", fontFamily: "var(--lumii-font-sans)" }}
          >
            Criar conta
          </span>
        </div>
...
function Hero() {
  return (
    <section id="top" className="lumii-hero-section relative overflow-hidden px-12 pb-14 pt-20">
      {/* Background halos */}
      <div className="pointer-events-none absolute -top-48 left-1/5 h-[700px] w-[700px] rounded-full" style={{ background: "radial-gradient(circle, rgba(32,10,94,0.22), transparent 60%)", filter: "blur(30px)" }} />
      <div className="pointer-events-none absolute right-[-100px] top-32 h-[480px] w-[480px] rounded-full" style={{ background: "radial-gradient(circle, rgba(32,10,94,0.45), transparent 65%)", filter: "blur(40px)" }} />
      {/* Grid overlay */}
      ...
      <div className="relative mx-auto max-w-7xl">
        {/* Badge */}
        <div className="mb-7 inline-flex items-center gap-2 rounded-full border px-3 py-1.5 text-[11px] font-semibold tracking-[0.04em] text-purple-300" style={{ background: "rgba(32,10,94,0.08)", borderColor: "rgba(32,10,94,0.25)" }}>
          <span className="h-[7px] w-[7px] rounded-full bg-yellow-400" style={{ boxShadow: "0 0 10px #ffe566", animation: "lumii-pulse 1.8s ease-in-out infinite" }} />
        ...
        >
          ...
          <em
            style={{ background: "linear-gradient(120deg, #6247c7 0%, #3a1a9e 40%, #200a5e 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text", fontStyle: "italic" }}
          >
        ...
        <div className="lumii-hero-actions mb-14 flex flex-wrap items-center gap-3">
          {/* TEMPORARIAMENTE DESATIVADO — remover aria-disabled/tabIndex/style overrides para reativar */}
          <Link
            href="/login/criar-conta"
            aria-disabled="true"
            tabIndex={-1}
            title="Cadastros temporariamente pausados"
            className="inline-flex items-center gap-2.5 rounded-xl border-none px-6 py-4 text-[15px] font-semibold text-[#0c0525] transition-all hover:-translate-y-px hover:shadow-2xl"
            style={{ background: "linear-gradient(135deg, #ffe566, #f5d030)", boxShadow: "0 12px 32px rgba(32,10,94,0.30), inset 0 1px 0 rgba(255,255,255,0.30)", pointerEvents: "none", opacity: 0.5, cursor: "not-allowed" }}
          >
            Começar agora
        ...
        {/* Stats strip */}
        <div className="lumii-hero-stats flex flex-wrap items-center gap-x-12 gap-y-4">
          {[
...
function DashPreview() {
  ...
  return (
    <section className="relative overflow-hidden px-12 py-20" id="solucoes">
      <div className="pointer-events-none absolute inset-0 opacity-30" style={{ background: "radial-gradient(ellipse at center, rgba(32,10,94,0.08), transparent 60%)" }} />
      <div className="relative mx-auto max-w-7xl">
        <Reveal>
          ...
          <h2 className="mb-4 text-4xl font-bold tracking-tight text-slate-100" style={{ letterSpacing: "-0.02em" }}>
            ...
            <span style={{ background: "linear-gradient(120deg, #6247c7, #200a5e)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>
              em tempo real
            </span>
          </h2>
        ...
        <Reveal delay={0.1} className="lumii-dash-scrollbox">
          {/* Dashboard mock */}
          <div className="overflow-hidden rounded-2xl border" style={{ background: "rgba(32,10,94,0.36)", borderColor: "rgba(255,255,255,0.10)", boxShadow: "0 30px 80px rgba(0,0,0,0.55), 0 0 60px rgba(32,10,94,0.05)", backdropFilter: "blur(20px)" }}>
            {/* Chrome bar */}
                ...
                {[
                  ...
                  <div
                    ...
                    style={{
                      ...
                      background: active ? "rgba(32,10,94,0.12)" : "transparent",
                      border: active ? "1px solid rgba(32,10,94,0.25)" : "1px solid transparent",
                      boxShadow: active ? "0 0 20px rgba(32,10,94,0.10)" : "none",
                    }}
                  >
                    {label}
                  </div>
              ...
              <div className="flex-1 p-5 min-w-0">
                ...
                <div className="mb-4 flex flex-wrap items-start justify-between gap-3">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    {/* KPI chips */}
                    <div className="rounded-xl border px-3 py-1.5 text-[11px] font-semibold text-purple-300" style={{ background: "rgba(32,10,94,0.10)", borderColor: "rgba(32,10,94,0.30)" }}>
                      {winning} Vencendo
                    </div>
                    ...
                    <button
                      ...
                      style={{
                        background: bananaOnly ? "rgba(32,10,94,0.15)" : "rgba(255,255,255,0.04)",
                        border: bananaOnly ? "1px solid rgba(32,10,94,0.45)" : "1px solid rgba(255,255,255,0.12)",
                        color: bananaOnly ? "#6247c7" : "#94a3b8",
                      }}
                    >
                      🍌 Só Bananas
                    </button>
                        ...
                        >
                          ...
                          {row.comp.map((price, ci) => (
                            <td
                              ...
                              style={{ color: row.best === ci ? "#ffe566" : "#94a3b8", fontWeight: row.best === ci ? 600 : 400 }}
                            >
                              {fmtBRL(price)}
                            </td>
                          ))}
                          <td className="px-3 py-2.5 text-right">
                            <span
                              ...
                              style={{
                                background: row.status === "vencendo" ? "rgba(255,229,102,0.12)" : row.status === "perdendo" ? "rgba(248,113,113,0.12)" : "rgba(148,163,184,0.08)",
                                color: row.status === "vencendo" ? "#ffe566" : row.status === "perdendo" ? "#f87171" : "#94a3b8",
                                border: `1px solid ${row.status === "vencendo" ? "rgba(255,229,102,0.25)" : row.status === "perdendo" ? "rgba(248,113,113,0.25)" : "rgba(148,163,184,0.18)"}`,
                              }}
                            >
...
function LumiiAI() {
  ...
  return (
    <section id="lumii-ia" className="relative overflow-hidden px-12 py-28">
      <div className="pointer-events-none absolute left-[10%] top-[30%] h-[520px] w-[520px] rounded-full" style={{ background: "radial-gradient(circle, rgba(32,10,94,0.25), transparent 70%)", filter: "blur(20px)" }} />
      <div className="pointer-events-none absolute bottom-[10%] right-[5%] h-[480px] w-[480px] rounded-full" style={{ background: "radial-gradient(circle, rgba(32,10,94,0.18), transparent 70%)", filter: "blur(30px)" }} />
      <div
        className="pointer-events-none absolute inset-0"
        style={{ background: "linear-gradient(180deg, transparent 0%, rgba(8,3,26,0.55) 25%, rgba(8,3,26,0.55) 75%, transparent 100%)" }}
      />

      <div className="relative mx-auto max-w-7xl">
        {/* Ribbon */}
        <div className="mb-8 inline-flex items-center gap-2.5 rounded-full border px-3.5 py-2 text-[11px] font-bold tracking-[0.18em] text-purple-300 uppercase" style={{ background: "rgba(32,10,94,0.10)", borderColor: "rgba(32,10,94,0.35)" }}>
          <span className="h-2 w-2 rounded-full bg-yellow-400" style={{ boxShadow: "0 0 12px #ffe566", animation: "lumii-pulse 1.6s ease-in-out infinite" }} />
        ...
        <Reveal>
          <div className="mb-16 grid gap-16 md:grid-cols-[1.5fr_1fr] md:items-end">
            <h2
              ...
              style={{ fontSize: "clamp(56px, 7vw, 96px)", letterSpacing: "-0.045em", lineHeight: 0.97 }}
            >
              Conheça a{" "}
              <em
                style={{ display: "inline-block", background: "linear-gradient(120deg, #ffe566 0%, #f5d030 35%, #e6c020 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text", fontStyle: "italic" }}
              >
                Lumii
              </em>
            </h2>
        ...
        <div className="grid items-stretch gap-12 md:grid-cols-[1fr_1.2fr]">
          ...
          <Reveal>
            <div>
              {[
                ...
                >
                  <div className="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-xl border text-purple-300" style={{ background: "rgba(32,10,94,0.10)", borderColor: "rgba(32,10,94,0.25)", boxShadow: "inset 0 0 20px rgba(32,10,94,0.10)" }}>
          ...
          {/* Chat preview */}
          <Reveal delay={0.1}>
            <div className="flex flex-col overflow-hidden rounded-2xl border" style={{ background: "linear-gradient(180deg, rgba(15,8,38,0.95), rgba(8,3,26,0.95))", borderColor: "rgba(255,255,255,0.10)", boxShadow: "0 30px 80px rgba(0,0,0,0.55), 0 0 60px rgba(32,10,94,0.08)", backdropFilter: "blur(20px)" }}>
              {/* Header */}
              <div className="flex items-center justify-between border-b px-5 py-4" style={{ borderColor: "rgba(255,255,255,0.06)" }}>
                <div className="flex items-center gap-3">
                  <div className="flex h-9 w-9 items-center justify-center rounded-xl text-[#0c0525]" style={{ background: "linear-gradient(135deg, #ffe566, #f5d030)", boxShadow: "0 0 20px rgba(32,10,94,0.35)" }}>
                  ...
                  <div>
                    ...
                    <div className="mt-0.5 flex items-center gap-1.5 text-[11px] text-purple-300">
                      <span className="h-1.5 w-1.5 rounded-full bg-yellow-400" style={{ boxShadow: "0 0 6px #ffe566" }} />
                      Online agora
                    </div>
                  </div>
                </div>
                <span className="rounded-full border px-2.5 py-1 text-[9px] font-bold tracking-[0.16em] text-purple-300 uppercase" style={{ background: "rgba(32,10,94,0.10)", borderColor: "rgba(32,10,94,0.25)" }}>
                  Lumii
                </span>
              </div>
                  ...
                  <div key={i} className={`flex ${msg.role === "user" ? "justify-end" : "justify-start"}`}>
                    <div
                      ...
                      style={{
                        ...
                        background: msg.role === "user" ? "rgba(255,255,255,0.06)" : "rgba(32,10,94,0.10)",
                        border: msg.role === "user" ? "1px solid rgba(255,255,255,0.10)" : "1px solid rgba(32,10,94,0.20)",
                        color: msg.role === "user" ? "#e2e8f0" : "#ffe566",
                      }}
                    >
                      {msg.text}
                    </div>
              ...
              <div className="border-t p-4" style={{ borderColor: "rgba(255,255,255,0.06)" }}>
                <div className="flex items-center gap-3 rounded-xl border px-4 py-3" style={{ background: "rgba(255,255,255,0.04)", borderColor: "rgba(255,255,255,0.10)" }}>
                  ...
                  <button className="flex h-7 w-7 items-center justify-center rounded-lg text-[#0c0525]" style={{ background: "linear-gradient(135deg, #ffe566, #f5d030)" }}>
  ...
  return (
    <section className="px-12 py-24" id="recursos">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="lumii-solutions-grid grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {cards.map(({ icon, title, body }, i) => (
            <Reveal key={title} delay={i * 0.05}>
              <div
                className="group flex flex-col rounded-2xl border p-6 transition-all duration-300 hover:border-purple-500/20"
                style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.08)", boxShadow: "0 8px 32px rgba(0,0,0,0.20)" }}
              >
                <div className="mb-4 flex h-11 w-11 items-center justify-center rounded-xl border text-purple-300 transition-all group-hover:shadow-purple-500/20" style={{ background: "rgba(32,10,94,0.10)", borderColor: "rgba(32,10,94,0.25)" }}>
                  {icon}
                </div>
...
function KeyFeatures() {
  return (
    <section className="lumii-features-section px-12 py-24" style={{ background: "linear-gradient(180deg, transparent, rgba(32,10,94,0.04), transparent)" }}>
      <div className="mx-auto max-w-7xl">
        <Reveal>
        ...
        <div className="lumii-features-grid grid gap-8 md:grid-cols-2">
          {[
            {
...
function Roadmap() {
  ...
  return (
    <section id="roadmap" className="relative overflow-hidden px-12 py-24">
      <div className="pointer-events-none absolute left-1/2 top-1/2 h-[400px] w-[900px] -translate-x-1/2 -translate-y-1/2 rounded-full" style={{ background: "radial-gradient(ellipse, rgba(32,10,94,0.10), transparent 70%)", filter: "blur(20px)" }} />
      <div className="relative mx-auto max-w-7xl">
        <Reveal>
        ...
        <Reveal delay={0.1}>
          <div className="relative pt-8">
            {/* Rail */}
            <div
              className="lumii-roadmap-rail absolute left-7 right-7 top-[52px] h-0.5 rounded-full"
              style={{ background: "linear-gradient(90deg, #3a1a9e 0%, #200a5e 25%, rgba(32,10,94,0.6) 38%, rgba(255,255,255,0.10) 42%, rgba(255,255,255,0.10) 100%)" }}
            />
            <div className="lumii-roadmap-grid grid grid-cols-5 gap-4 relative z-10">
              {steps.map((step, i) => (
                <div key={i} className="flex flex-col items-start px-1">
                  ...
                  <div
                    ...
                    style={
                      step.state === "done"
                        ? { background: "linear-gradient(135deg, #3a1a9e, #200a5e)", border: "1px solid rgba(255,255,255,0.20)", boxShadow: "0 0 24px rgba(32,10,94,0.40), inset 0 1px 0 rgba(255,255,255,0.3)", color: "#0c0525" }
                        : step.state === "now"
                          ? { background: "rgba(32,10,94,0.10)", border: "2px solid #200a5e", boxShadow: "0 0 24px rgba(32,10,94,0.30)", color: "#6247c7" }
                          : { background: "rgba(255,255,255,0.03)", border: "1px dashed rgba(255,255,255,0.18)", color: "#64748b" }
                    }
                  >
                    {step.state === "now" && (
                      <span className="pointer-events-none absolute inset-[-8px] rounded-full border-2 border-purple-500/40" style={{ animation: "lumii-ring 2.2s ease-out infinite" }} />
                    )}
                    {step.state === "done" ? (
                  ...
                  <span
                    ...
                    style={
                      step.state === "done"
                        ? { color: "#ffe566", background: "rgba(255,229,102,0.10)", borderColor: "rgba(255,229,102,0.30)" }
                        : step.state === "now"
                          ? { color: "#6247c7", background: "rgba(32,10,94,0.10)", borderColor: "rgba(32,10,94,0.30)" }
  ...
  return (
    <section id="preco" className="relative px-12 py-24">
      <div className="mx-auto max-w-7xl">
        ...
        <Reveal delay={0.1}>
          <div
            className="lumii-pricing-card relative mx-auto max-w-2xl overflow-hidden rounded-3xl border p-12"
            style={{ background: "linear-gradient(180deg, rgba(32,10,94,0.10) 0%, rgba(255,255,255,0.03) 50%)", borderColor: "rgba(32,10,94,0.25)", boxShadow: "0 30px 80px rgba(0,0,0,0.40), 0 0 80px rgba(32,10,94,0.10)", backdropFilter: "blur(20px)" }}
          >
            <div className="pointer-events-none absolute right-[-100px] top-[-100px] h-80 w-80 rounded-full" style={{ background: "radial-gradient(circle, rgba(255, 230, 102, 0.40), transparent 70%)" }} />

            <div className="mb-8 flex items-center justify-between">
              <span className="text-sm font-bold tracking-[0.16em] text-purple-300 uppercase">Plano Lumii</span>
              <span className="flex items-center gap-1.5 rounded-full border px-2.5 py-1 text-[10px] font-bold tracking-[0.06em] text-yellow-400" style={{ background: "rgba(255,229,102,0.12)", borderColor: "rgba(255,229,102,0.30)" }}>
            ...
            <div className="lumii-pricing-features mb-8 grid gap-3 sm:grid-cols-2">
              {[
                ...
                <div key={feat} className="flex items-start gap-2.5 text-sm text-slate-300">
                  <svg className="mt-0.5 flex-shrink-0 text-purple-400" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg>
                  {feat}
                </div>
              ))}
            </div>
            ...
            <Link
              ...
              tabIndex={-1}
              title="Cadastros temporariamente pausados"
              className="flex w-full items-center justify-center gap-2 rounded-full py-4 text-base font-bold text-[#0c0525] transition-all hover:-translate-y-px"
              style={{ background: "linear-gradient(135deg, #ffe566 0%, #f5d030 100%)", boxShadow: "0 0 40px rgba(32,10,94,0.30), inset 0 1px 0 rgba(255,255,255,0.30)", pointerEvents: "none", opacity: 0.5, cursor: "not-allowed" }}
            >
              Começar agora
...
function Testimonials() {
  return (
    <section className="lumii-testimonials-section px-12 py-24">
      <div className="mx-auto max-w-7xl">
        <Reveal>
          ...
          {[
            ...
            <Reveal key={i} delay={i * 0.06}>
              <div
                ...
                style={{ background: "rgba(255,255,255,0.03)", borderColor: "rgba(255,255,255,0.08)" }}
              >
                <svg className="mb-4 text-purple-500/40" width="28" height="22" viewBox="0 0 40 28" fill="currentColor">
...
function Footer() {
  return (
    <>
        ...
        <div className="mx-auto max-w-7xl">
          <Reveal>
            <div
              ...
              style={{ background: "linear-gradient(135deg, rgba(32,10,94,0.12), rgba(32,10,94,0.06))", borderColor: "rgba(32,10,94,0.30)", boxShadow: "0 0 80px rgba(32,10,94,0.08)" }}
            >
              <div className="pointer-events-none absolute inset-0" style={{ background: "radial-gradient(ellipse at center, rgba(32,10,94,0.15), transparent 60%)" }} />
              ...
              <div className="lumii-cta-actions relative flex flex-wrap items-center justify-center gap-3">
                {/* TEMPORARIAMENTE DESATIVADO — remover aria-disabled/tabIndex/style overrides para reativar */}
                <Link
                  href="/login/criar-conta"
                  aria-disabled="true"
                  tabIndex={-1}
                  title="Cadastros temporariamente pausados"
                  className="inline-flex items-center gap-2 rounded-full px-8 py-4 text-base font-bold text-[#0c0525] transition-all hover:-translate-y-px"
                  style={{ background: "linear-gradient(135deg, #ffe566, #f5d030)", boxShadow: "0 12px 32px rgba(32,10,94,0.30)", pointerEvents: "none", opacity: 0.5, cursor: "not-allowed" }}
                >
                  Criar conta grátis
                </Link>
                <a
      ...
      {/* Footer */}
      <footer className="lumii-footer border-t px-12 py-10" style={{ borderColor: "rgba(255,255,255,0.06)" }}>
        <div className="mx-auto max-w-7xl">
          <div className="lumii-footer-inner flex flex-wrap items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              <BrandMark size={28} />
